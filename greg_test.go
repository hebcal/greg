...
func TestGreg2RDNegative(t *testing.T) {
	assert := assert.New(t)
	assert.Equal(int64(0), greg.ToRD(-1, time.December, 31))
	assert.Equal(int64(-1), greg.ToRD(-1, time.December, 30))
	assert.Equal(int64(-2), greg.ToRD(-1, time.December, 29))
	assert.Equal(int64(-48), greg.ToRD(-1, time.November, 13))
	assert.Equal(int64(-61), greg.ToRD(-1, time.October, 31))
	assert.Equal(int64(-91), greg.ToRD(-1, time.October, 1))
	assert.Equal(int64(-305), greg.ToRD(-1, time.March, 1))
	assert.Equal(int64(-306), greg.ToRD(-1, time.February, 29))
	assert.Equal(int64(-307), greg.ToRD(-1, time.February, 28))
	assert.Equal(int64(-308), greg.ToRD(-1, time.February, 27))
	assert.Equal(int64(-334), greg.ToRD(-1, time.February, 1))
	assert.Equal(int64(-335), greg.ToRD(-1, time.January, 31))
	assert.Equal(int64(-350), greg.ToRD(-1, time.January, 16))
	assert.Equal(int64(-365), greg.ToRD(-1, time.January, 1))
	assert.Equal(int64(-366), greg.ToRD(-2, time.December, 31))
}

func TestGreg2RDNegative2(t *testing.T) {
	assert := assert.New(t)
	assert.Equal(int64(-396), greg.ToRD(-2, time.December, 1))
	assert.Equal(int64(-730), greg.ToRD(-2, time.January, 1))
	assert.Equal(int64(-1095), greg.ToRD(-3, time.January, 1))
	assert.Equal(int64(-1460), greg.ToRD(-4, time.January, 1))
	assert.Equal(int64(-36171), greg.ToRD(-100, time.December, 20))
	assert.Equal(int64(-365077), greg.ToRD(-1000, time.June, 15))
	assert.Equal(int64(-36536), greg.ToRD(-101, time.December, 20))
}
